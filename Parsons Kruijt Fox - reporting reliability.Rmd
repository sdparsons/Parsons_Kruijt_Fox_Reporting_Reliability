---
title             : "Psychological Science needs a standard practice of reporting reliability"
shorttitle        : "Routine reporting of measurement reliability"
...
Using the re-arranged formula we can calculate the expected power for an observable correlation that has been powered at 80% to observe a correlation of at least the size of the expected “true” correlation. To illustrate, we might expect a “true” correlation of .5 between two measures. If, both measures have reliability of .9 the observable correlation drops to;
