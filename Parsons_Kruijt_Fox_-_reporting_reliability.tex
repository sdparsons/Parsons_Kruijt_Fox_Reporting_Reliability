...
1         1 57      0.46   0.31    0.61          0.63   0.48    0.76
2         2 57      0.39   0.24    0.54          0.56   0.39    0.70
\end{verbatim}
...
\emph{Permutation-based split-half reliability estimates were obtained, separately for each time-point using the splithalf package (version 0.5.2; Parsons, 2019) averaging the results of 5000 random splits. Reliability estimates (Spearman-Brown corrected) were; time 1: r\textsubscript{SB} = 0.63, 95\%CI {[}0.48,0.76{]} (uncorrected estimates were r = 0.46, 95\%CI {[}0.31,0.61{]}), time 2: r\textsubscript{SB} = 0.56, 95\%CI {[}0.39,0.70{]} (uncorrected estimates were r = 0.39, 95\%CI {[}0.24,0.54{]}).}
